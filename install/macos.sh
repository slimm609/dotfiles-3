...
# Hide icon for internal hard drives
...
# Set the default folder for new finder window to home folder
# $HOME var doesn't have a trailing slash so we add it here.
